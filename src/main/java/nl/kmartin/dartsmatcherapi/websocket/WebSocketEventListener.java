...
import nl.kmartin.dartsmatcherapi.websocket.response.WebSocketResponseEvent;
...
public class WebSocketEventListener {
     ...
     */
    @EventListener
    public void handleWebSocketExceptionEvent(WebSocketErrorEvent event) {
        sendToUser(
     ...
     */
    @EventListener
    public void handleWebSocketSendToUserEvent(WebSocketResponseEvent event) {
        sendToUser(
