...
public final class MessageKeys {
    ...
    public static final String MESSAGE_X01_INVALID_SCORE = "message.x01.invalid.score";
    public static final String MESSAGE_X01_TURN_ALREADY_EXISTS = "message.x01.turn.already.exists";
